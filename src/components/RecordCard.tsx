...
export default function RecordCard({ ...recordCard} : Records) {
  ...
  return (
    <div onClick={() => handleNavigateDetail(recordCard.id)} className='bg-orange-600 relative p-3 m-3 w-72 h-44 rounded-xl hover:scale-105 transition max-mobile:w-40 max-mobile:h-64'>
